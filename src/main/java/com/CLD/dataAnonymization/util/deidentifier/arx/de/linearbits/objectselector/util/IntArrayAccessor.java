...
/**
 * An accessor arrays of ints
 * 
 * @author Fabian Prasser
 */
public class IntArrayAccessor extends PrimitiveArrayAccessor<int[]>{
     ...
     * @param header
     */
    public IntArrayAccessor(String[] header) {
     ...
     * @param datatypes
     */
    public IntArrayAccessor(String[] header, DataType<?>[] datatypes) {
        super(header, datatypes);
    }

    @Override
    public Object getValue(int[] object, String context) {
