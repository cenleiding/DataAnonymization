...
package com.CLD.dataAnonymization.util.deidentifier.arx.metric;
...
import com.CLD.dataAnonymization.util.deidentifier.arx.ARXConfiguration;
import com.CLD.dataAnonymization.util.deidentifier.arx.DataDefinition;
import com.CLD.dataAnonymization.util.deidentifier.arx.DataSubset;
import com.CLD.dataAnonymization.util.deidentifier.arx.RowSet;
import com.CLD.dataAnonymization.util.deidentifier.arx.criteria.PrivacyCriterion;
import com.CLD.dataAnonymization.util.deidentifier.arx.framework.check.groupify.HashGroupify;
import com.CLD.dataAnonymization.util.deidentifier.arx.framework.check.groupify.HashGroupifyEntry;
import com.CLD.dataAnonymization.util.deidentifier.arx.framework.data.Data;
import com.CLD.dataAnonymization.util.deidentifier.arx.framework.data.DataManager;
import com.CLD.dataAnonymization.util.deidentifier.arx.framework.data.GeneralizationHierarchy;
import com.CLD.dataAnonymization.util.deidentifier.arx.framework.lattice.Transformation;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.AbstractILMultiDimensional;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.AbstractMetricMultiDimensional;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.ILSingleDimensional;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDHeight;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNMLoss;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNMLossPotentiallyPrecomputed;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNMLossPrecomputed;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNMPrecision;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNUEntropy;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNUEntropyPotentiallyPrecomputed;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNUEntropyPrecomputed;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNUNMEntropy;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNUNMEntropyPotentiallyPrecomputed;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNUNMEntropyPrecomputed;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNUNMNormalizedEntropy;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNUNMNormalizedEntropyPotentiallyPrecomputed;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDNUNMNormalizedEntropyPrecomputed;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricMDPrecision;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricSDAECS;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricSDClassification;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricSDDiscernability;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricSDNMAmbiguity;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricSDNMDiscernability;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricSDNMEntropyBasedInformationLoss;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricSDNMKLDivergence;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.MetricSDNMPublisherPayout;
import com.CLD.dataAnonymization.util.deidentifier.arx.metric.v2.__MetricV2;
