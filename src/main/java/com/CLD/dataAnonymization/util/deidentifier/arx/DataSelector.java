...
import com.CLD.dataAnonymization.util.deidentifier.arx.de.linearbits.objectselector.Selector;
import com.CLD.dataAnonymization.util.deidentifier.arx.de.linearbits.objectselector.SelectorBuilder;
    ...
    private class DataAccessor implements IAccessor<Integer>{
        ...
        private Map<String, DataType<?>> getTypes() {
            ...
            for (int i=0; i<handle.getNumColumns(); i++){
                ...
                com.CLD.dataAnonymization.util.deidentifier.arx.DataType<?> type = definition.getDataType(attribute);
                if (type instanceof com.CLD.dataAnonymization.util.deidentifier.arx.DataType.ARXDecimal){
                    String format = ((ARXDecimal)type).getFormat();
                    result.put(attribute, DataType.NUMERIC(format));
                } else if (type instanceof com.CLD.dataAnonymization.util.deidentifier.arx.DataType.ARXInteger) {
                    result.put(attribute, DataType.NUMERIC);
                } else if (type instanceof com.CLD.dataAnonymization.util.deidentifier.arx.DataType.ARXString) {
                    result.put(attribute, DataType.STRING);                    
                } else if (type instanceof com.CLD.dataAnonymization.util.deidentifier.arx.DataType.ARXDate){
