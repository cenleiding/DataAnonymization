...
import com.CLD.dataAnonymization.util.deidentifier.arx.criteria.*;
...
public class ARXConfiguration implements Serializable, Cloneable {
    ...
    public static class ARXConfigurationInternal {
         ...
         * @param clazz
         * @return
         * @see com.CLD.dataAnonymization.util.deidentifier.arx.ARXConfiguration#getPrivacyModel(Class)
         */
         ...
         * @param clazz
         * @return
         * @see com.CLD.dataAnonymization.util.deidentifier.arx.ARXConfiguration#isPrivacyModelSpecified(Class)
         */
